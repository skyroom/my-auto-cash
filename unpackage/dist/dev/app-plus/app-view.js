...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'5cdd1d0f'])
Z([3,'_view 5cdd1d0f cart-page-box page-box'])
Z([3,'sdd'])
...
var x=['./common/slots.wxml','./pages/cart/cart.vue.wxml','./pages/cart/cart.wxml','./cart.vue.wxml','./pages/choose/choose.vue.wxml','./pages/choose/choose.wxml','./choose.vue.wxml','./pages/index/index.vue.wxml','./pages/index/index.wxml','./index.vue.wxml'];d_[x[0]]={}
...
var css_id;
var info = info || {};
var _C= [[[2,1],],["wx-uni-page-body, .",[1],"page-box { width: 100%; height: 100%; }\n.",[1],"hover-class { opacity: 0.7; }\n",],];
